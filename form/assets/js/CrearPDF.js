    ...
    $(img).on('load', function() {
        try {
            ...
            for (var i = 1; i <= nfilas; i++) {
                ...
                doc.text(145, cc, fecha3[4] + "" + fecha3[5]); // terminacion mes 
                doc.text(150, cc, fecha3[0]); // terminacion año 
                doc.tex(155, cc, fecha3[1]);
                doc.tex(160, cc, fecha3[2]);
                doc.tex(165, cc, fecha3[3]);
